...
use Vegas\Validation\Validator\ExclusionIn;

class ExclusionInTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $validator = new ExclusionIn(array('domain' => array(1, 'abc', '<oreo>')));
